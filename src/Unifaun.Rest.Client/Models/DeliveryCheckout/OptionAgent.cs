...
{
    public partial class OptionAgent
    {
        ...
        public PurpleOpeningHourSpecialDay[] OpeningHourSpecialDays { get; set; }

        [JsonPropertyName("openingHourWeekdays")]
        public PurpleOpeningHourWeekday[] OpeningHourWeekdays { get; set; }
